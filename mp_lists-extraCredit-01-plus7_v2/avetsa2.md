...
==6485== Using Valgrind-3.13.0 and LibVEX; rerun with -h for copyright info
==6485== Command: ./test -r xml "List::insertFront\ size"
==6485== 
==6485== Conditional jump or move depends on uninitialised value(s)
==6485==    at 0x42CA4F: List<int>::insertFront(int const&) (List.hpp:55)
==6485==    by 0x42610A: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==6485==    by 0x468442: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==6485==    by 0x4595B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==6485==    by 0x4594E8: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==6485==    by 0x456136: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==6485==    by 0x4547A7: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==6485==    by 0x45D3E1: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==6485==    by 0x45C07F: Catch::Session::runInternal() (catch.hpp:10149)
==6485==    by 0x45BD3E: Catch::Session::run() (catch.hpp:10106)
==6485==    by 0x45BCBC: Catch::Session::run(int, char**) (catch.hpp:10074)
==6485==    by 0x487301: main (catch.hpp:13613)
==6485== 
==6485== Conditional jump or move depends on uninitialised value(s)
==6485==    at 0x42CA96: List<int>::insertFront(int const&) (List.hpp:58)
==6485==    by 0x42610A: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==6485==    by 0x468442: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==6485==    by 0x4595B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==6485==    by 0x4594E8: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==6485== 
==6485== Conditional jump or move depends on uninitialised value(s)
==6485==    at 0x459660: Catch::RunContext::handleExpr(Catch::AssertionInfo const&, Catch::ITransientExpression const&, Catch::AssertionReaction&) (catch.hpp:9683)
==6485==    by 0x438B9E: Catch::AssertionHandler::handleExpr(Catch::ITransientExpression const&) (catch.hpp:5467)
==6485==    by 0x426269: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:25)
==6485==    by 0x468442: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==6485==    by 0x4595B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==6485==    by 0x4594E8: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==6485==    by 0x456136: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
...
==6485== 
==6485== HEAP SUMMARY:
==6485==     in use at exit: 240 bytes in 10 blocks
==6485==   total heap usage: 2,113 allocs, 2,103 frees, 251,496 bytes allocated
==6485== 
==6485== 240 bytes in 10 blocks are definitely lost in loss record 1 of 1
==6485==    at 0x4C29BC3: malloc (vg_replace_malloc.c:299)
==6485==    by 0x4ED2D29: operator new(unsigned long) (in /class/cs225/lm35/lib/libc++.so.1.0)
==6485==    by 0x42CA03: List<int>::insertFront(int const&) (List.hpp:51)
==6485==    by 0x42610A: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==6485==    by 0x468442: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==6485==    by 0x4595B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==6485==    by 0x4594E8: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==6485== 
==6485== LEAK SUMMARY:
==6485==    definitely lost: 240 bytes in 10 blocks
...
==6485== Use --track-origins=yes to see where uninitialised values come from
==6485== ERROR SUMMARY: 13 errors from 4 contexts (suppressed: 0 from 0)
...
==6497== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==6497== Using Valgrind-3.13.0 and LibVEX; rerun with -h for copyright info
==6497== Command: ./test -r xml "List::_destroy\ empty\ list"
==6497== 
==6497== 
==6497== HEAP SUMMARY:
==6497==     in use at exit: 0 bytes in 0 blocks
==6497==   total heap usage: 2,121 allocs, 2,121 frees, 252,328 bytes allocated
==6497== 
==6497== All heap blocks were freed -- no leaks are possible
==6497== 
==6497== For counts of detected and suppressed errors, rerun with: -v
==6497== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 0 from 0)
...
This report was generated for **avetsa2** using **a2bc5d67a7670b3143082b111d2de91db668fe1a** (from **February 19th 2019, 12:05:00 am**)
