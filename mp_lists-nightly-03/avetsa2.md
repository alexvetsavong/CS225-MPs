...
==19859== Using Valgrind-3.13.0 and LibVEX; rerun with -h for copyright info
==19859== Command: ./test -r xml "List::insertFront\ size"
==19859== 
==19859== Conditional jump or move depends on uninitialised value(s)
==19859==    at 0x43DD6F: List<int>::insertFront(int const&) (List.hpp:55)
==19859==    by 0x4376EA: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==19859==    by 0x477F72: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==19859==    by 0x4690E6: Catch::TestCase::invoke() const (catch.hpp:10793)
==19859==    by 0x469018: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==19859==    by 0x465C66: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==19859==    by 0x4642D7: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==19859==    by 0x46CF11: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==19859==    by 0x46BBAF: Catch::Session::runInternal() (catch.hpp:10149)
==19859==    by 0x46B86E: Catch::Session::run() (catch.hpp:10106)
==19859==    by 0x46B7EC: Catch::Session::run(int, char**) (catch.hpp:10074)
==19859==    by 0x496E31: main (catch.hpp:13613)
==19859== 
==19859== Conditional jump or move depends on uninitialised value(s)
==19859==    at 0x43DDB6: List<int>::insertFront(int const&) (List.hpp:58)
==19859==    by 0x4376EA: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==19859==    by 0x477F72: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==19859==    by 0x4690E6: Catch::TestCase::invoke() const (catch.hpp:10793)
==19859==    by 0x469018: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==19859== 
==19859== Conditional jump or move depends on uninitialised value(s)
==19859==    at 0x469190: Catch::RunContext::handleExpr(Catch::AssertionInfo const&, Catch::ITransientExpression const&, Catch::AssertionReaction&) (catch.hpp:9683)
==19859==    by 0x4486CE: Catch::AssertionHandler::handleExpr(Catch::ITransientExpression const&) (catch.hpp:5467)
==19859==    by 0x437849: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:25)
==19859==    by 0x477F72: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==19859==    by 0x4690E6: Catch::TestCase::invoke() const (catch.hpp:10793)
==19859==    by 0x469018: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==19859==    by 0x465C66: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
...
==19859== 
==19859== HEAP SUMMARY:
==19859==     in use at exit: 240 bytes in 10 blocks
==19859==   total heap usage: 2,328 allocs, 2,318 frees, 267,368 bytes allocated
==19859== 
==19859== 240 bytes in 10 blocks are definitely lost in loss record 1 of 1
==19859==    at 0x4C29BC3: malloc (vg_replace_malloc.c:299)
==19859==    by 0x4ED2D29: operator new(unsigned long) (in /class/cs225/lm35/lib/libc++.so.1.0)
==19859==    by 0x43DD23: List<int>::insertFront(int const&) (List.hpp:51)
==19859==    by 0x4376EA: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==19859==    by 0x477F72: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==19859==    by 0x4690E6: Catch::TestCase::invoke() const (catch.hpp:10793)
==19859==    by 0x469018: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==19859== 
==19859== LEAK SUMMARY:
==19859==    definitely lost: 240 bytes in 10 blocks
==19859==    indirectly lost: 0 bytes in 0 blocks
==19859==      possibly lost: 0 bytes in 0 blocks
==19859==    still reachable: 0 bytes in 0 blocks
==19859==         suppressed: 0 bytes in 0 blocks
==19859== 
==19859== For counts of detected and suppressed errors, rerun with: -v
==19859== Use --track-origins=yes to see where uninitialised values come from
==19859== ERROR SUMMARY: 13 errors from 4 contexts (suppressed: 0 from 0)
...
==19871== Command: ./test -r xml "List::_destroy\ empty\ list"
==19871== 
==19871== 
==19871== HEAP SUMMARY:
==19871==     in use at exit: 0 bytes in 0 blocks
==19871==   total heap usage: 2,336 allocs, 2,336 frees, 268,200 bytes allocated
==19871== 
