...
```
==19767== Memcheck, a memory error detector
==19767== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==19767== Using Valgrind-3.13.0 and LibVEX; rerun with -h for copyright info
==19767== Command: ./test -r xml "List::insertFront\ size"
==19767== 
==19767== Conditional jump or move depends on uninitialised value(s)
==19767==    at 0x42CA4F: List<int>::insertFront(int const&) (List.hpp:55)
==19767==    by 0x42610A: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==19767==    by 0x468442: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==19767==    by 0x4595B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==19767==    by 0x4594E8: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==19767==    by 0x456136: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==19767==    by 0x4547A7: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==19767==    by 0x45D3E1: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==19767==    by 0x45C07F: Catch::Session::runInternal() (catch.hpp:10149)
==19767==    by 0x45BD3E: Catch::Session::run() (catch.hpp:10106)
==19767==    by 0x45BCBC: Catch::Session::run(int, char**) (catch.hpp:10074)
==19767==    by 0x487301: main (catch.hpp:13613)
==19767== 
==19767== Conditional jump or move depends on uninitialised value(s)
==19767==    at 0x42CA96: List<int>::insertFront(int const&) (List.hpp:58)
==19767==    by 0x42610A: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==19767==    by 0x468442: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==19767==    by 0x4595B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==19767==    by 0x4594E8: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==19767== 
==19767== Conditional jump or move depends on uninitialised value(s)
==19767==    at 0x459660: Catch::RunContext::handleExpr(Catch::AssertionInfo const&, Catch::ITransientExpression const&, Catch::AssertionReaction&) (catch.hpp:9683)
==19767==    by 0x438B9E: Catch::AssertionHandler::handleExpr(Catch::ITransientExpression const&) (catch.hpp:5467)
==19767==    by 0x426269: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:25)
==19767==    by 0x468442: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==19767==    by 0x4595B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==19767==    by 0x4594E8: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==19767==    by 0x456136: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
...
==19767== 
==19767== HEAP SUMMARY:
==19767==     in use at exit: 240 bytes in 10 blocks
==19767==   total heap usage: 2,113 allocs, 2,103 frees, 251,496 bytes allocated
==19767== 
==19767== 240 bytes in 10 blocks are definitely lost in loss record 1 of 1
==19767==    at 0x4C29BC3: malloc (vg_replace_malloc.c:299)
==19767==    by 0x4ED2D29: operator new(unsigned long) (in /class/cs225/lm35/lib/libc++.so.1.0)
==19767==    by 0x42CA03: List<int>::insertFront(int const&) (List.hpp:51)
==19767==    by 0x42610A: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==19767==    by 0x468442: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==19767==    by 0x4595B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==19767==    by 0x4594E8: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==19767== 
==19767== LEAK SUMMARY:
==19767==    definitely lost: 240 bytes in 10 blocks
==19767==    indirectly lost: 0 bytes in 0 blocks
==19767==      possibly lost: 0 bytes in 0 blocks
==19767==    still reachable: 0 bytes in 0 blocks
==19767==         suppressed: 0 bytes in 0 blocks
==19767== 
==19767== For counts of detected and suppressed errors, rerun with: -v
==19767== Use --track-origins=yes to see where uninitialised values come from
==19767== ERROR SUMMARY: 13 errors from 4 contexts (suppressed: 0 from 0)
...
==19782== Command: ./test -r xml "List::_destroy\ empty\ list"
==19782== 
==19782== 
==19782== HEAP SUMMARY:
==19782==     in use at exit: 0 bytes in 0 blocks
==19782==   total heap usage: 2,121 allocs, 2,121 frees, 252,328 bytes allocated
==19782== 
...
This report was generated for **avetsa2** using **a1d89f4afa2a36cf320efca29d3c9dd8b30cb888** (from **February 24th 2019, 12:05:00 am**)
