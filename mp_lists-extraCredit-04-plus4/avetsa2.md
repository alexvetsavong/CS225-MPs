...
==25096== Using Valgrind-3.13.0 and LibVEX; rerun with -h for copyright info
==25096== Command: ./test -r xml "List::insertFront\ size"
==25096== 
==25096== Conditional jump or move depends on uninitialised value(s)
==25096==    at 0x42CA4F: List<int>::insertFront(int const&) (List.hpp:55)
==25096==    by 0x42610A: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==25096==    by 0x468442: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==25096==    by 0x4595B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==25096==    by 0x4594E8: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==25096==    by 0x456136: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==25096==    by 0x4547A7: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==25096==    by 0x45D3E1: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==25096==    by 0x45C07F: Catch::Session::runInternal() (catch.hpp:10149)
==25096==    by 0x45BD3E: Catch::Session::run() (catch.hpp:10106)
==25096==    by 0x45BCBC: Catch::Session::run(int, char**) (catch.hpp:10074)
==25096==    by 0x487301: main (catch.hpp:13613)
==25096== 
==25096== Conditional jump or move depends on uninitialised value(s)
==25096==    at 0x42CA96: List<int>::insertFront(int const&) (List.hpp:58)
==25096==    by 0x42610A: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==25096==    by 0x468442: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==25096==    by 0x4595B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==25096==    by 0x4594E8: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==25096== 
==25096== Conditional jump or move depends on uninitialised value(s)
==25096==    at 0x459660: Catch::RunContext::handleExpr(Catch::AssertionInfo const&, Catch::ITransientExpression const&, Catch::AssertionReaction&) (catch.hpp:9683)
==25096==    by 0x438B9E: Catch::AssertionHandler::handleExpr(Catch::ITransientExpression const&) (catch.hpp:5467)
==25096==    by 0x426269: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:25)
==25096==    by 0x468442: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==25096==    by 0x4595B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==25096==    by 0x4594E8: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==25096==    by 0x456136: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
...
==25096== 
==25096== HEAP SUMMARY:
==25096==     in use at exit: 240 bytes in 10 blocks
==25096==   total heap usage: 2,113 allocs, 2,103 frees, 251,496 bytes allocated
==25096== 
==25096== 240 bytes in 10 blocks are definitely lost in loss record 1 of 1
==25096==    at 0x4C29BC3: malloc (vg_replace_malloc.c:299)
==25096==    by 0x4ED2D29: operator new(unsigned long) (in /class/cs225/lm35/lib/libc++.so.1.0)
==25096==    by 0x42CA03: List<int>::insertFront(int const&) (List.hpp:51)
==25096==    by 0x42610A: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==25096==    by 0x468442: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==25096==    by 0x4595B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==25096==    by 0x4594E8: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==25096== 
==25096== LEAK SUMMARY:
==25096==    definitely lost: 240 bytes in 10 blocks
...
==25096== Use --track-origins=yes to see where uninitialised values come from
==25096== ERROR SUMMARY: 13 errors from 4 contexts (suppressed: 0 from 0)
...
==25110== Using Valgrind-3.13.0 and LibVEX; rerun with -h for copyright info
==25110== Command: ./test -r xml "List::_destroy\ empty\ list"
==25110== 
==25110== 
==25110== HEAP SUMMARY:
==25110==     in use at exit: 0 bytes in 0 blocks
==25110==   total heap usage: 2,121 allocs, 2,121 frees, 252,328 bytes allocated
==25110== 
==25110== All heap blocks were freed -- no leaks are possible
==25110== 
==25110== For counts of detected and suppressed errors, rerun with: -v
==25110== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 0 from 0)
