...
==22409== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==22409== Using Valgrind-3.13.0 and LibVEX; rerun with -h for copyright info
==22409== Command: ./test -r xml "List::insertFront\ size"
==22409== 
==22409== Conditional jump or move depends on uninitialised value(s)
==22409==    at 0x43DD6F: List<int>::insertFront(int const&) (List.hpp:55)
==22409==    by 0x4376EA: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==22409==    by 0x477F72: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==22409==    by 0x4690E6: Catch::TestCase::invoke() const (catch.hpp:10793)
==22409==    by 0x469018: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==22409==    by 0x465C66: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==22409==    by 0x4642D7: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==22409==    by 0x46CF11: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==22409==    by 0x46BBAF: Catch::Session::runInternal() (catch.hpp:10149)
==22409==    by 0x46B86E: Catch::Session::run() (catch.hpp:10106)
==22409==    by 0x46B7EC: Catch::Session::run(int, char**) (catch.hpp:10074)
==22409==    by 0x496E31: main (catch.hpp:13613)
==22409== 
==22409== Conditional jump or move depends on uninitialised value(s)
==22409==    at 0x43DDB6: List<int>::insertFront(int const&) (List.hpp:58)
==22409==    by 0x4376EA: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==22409==    by 0x477F72: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==22409==    by 0x4690E6: Catch::TestCase::invoke() const (catch.hpp:10793)
==22409==    by 0x469018: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==22409== 
==22409== Conditional jump or move depends on uninitialised value(s)
==22409==    at 0x469190: Catch::RunContext::handleExpr(Catch::AssertionInfo const&, Catch::ITransientExpression const&, Catch::AssertionReaction&) (catch.hpp:9683)
==22409==    by 0x4486CE: Catch::AssertionHandler::handleExpr(Catch::ITransientExpression const&) (catch.hpp:5467)
==22409==    by 0x437849: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:25)
==22409==    by 0x477F72: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==22409==    by 0x4690E6: Catch::TestCase::invoke() const (catch.hpp:10793)
==22409==    by 0x469018: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==22409==    by 0x465C66: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
...
==22409== 
==22409== HEAP SUMMARY:
==22409==     in use at exit: 240 bytes in 10 blocks
==22409==   total heap usage: 2,328 allocs, 2,318 frees, 267,368 bytes allocated
==22409== 
==22409== 240 bytes in 10 blocks are definitely lost in loss record 1 of 1
==22409==    at 0x4C29BC3: malloc (vg_replace_malloc.c:299)
==22409==    by 0x4ED2D29: operator new(unsigned long) (in /class/cs225/lm35/lib/libc++.so.1.0)
==22409==    by 0x43DD23: List<int>::insertFront(int const&) (List.hpp:51)
==22409==    by 0x4376EA: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==22409==    by 0x477F72: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==22409==    by 0x4690E6: Catch::TestCase::invoke() const (catch.hpp:10793)
==22409==    by 0x469018: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==22409== 
==22409== LEAK SUMMARY:
==22409==    definitely lost: 240 bytes in 10 blocks
==22409==    indirectly lost: 0 bytes in 0 blocks
==22409==      possibly lost: 0 bytes in 0 blocks
==22409==    still reachable: 0 bytes in 0 blocks
==22409==         suppressed: 0 bytes in 0 blocks
==22409== 
==22409== For counts of detected and suppressed errors, rerun with: -v
==22409== Use --track-origins=yes to see where uninitialised values come from
==22409== ERROR SUMMARY: 13 errors from 4 contexts (suppressed: 0 from 0)
...
```
==22416== Memcheck, a memory error detector
==22416== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==22416== Using Valgrind-3.13.0 and LibVEX; rerun with -h for copyright info
==22416== Command: ./test -r xml "List::_destroy\ empty\ list"
==22416== 
==22416== 
==22416== HEAP SUMMARY:
==22416==     in use at exit: 0 bytes in 0 blocks
==22416==   total heap usage: 2,336 allocs, 2,336 frees, 268,200 bytes allocated
==22416== 
==22416== All heap blocks were freed -- no leaks are possible
==22416== 
==22416== For counts of detected and suppressed errors, rerun with: -v
==22416== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 0 from 0)
...
This report was generated for **avetsa2** using **a2bc5d67a7670b3143082b111d2de91db668fe1a** (from **February 20th 2019, 12:05:00 am**)
